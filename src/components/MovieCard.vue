  ...
  <article class="movie-card">
    ...
    <div class="movie-card__content">
      ...
      <ul class="movie-card__info">
        <li class="movie-card__item">{{ this.item.year }}, {{ this.genres }}</li>
        <li class="movie-card__item" v-if="this.item.directors">Режиссёр: {{ this.directors }}</li>
...
.movie-card__time::before {
  content: url("@/assets/cadr.svg");
  position: absolute;
  right: 22px;
}
</style>
